...
def main():
    ...
    source = DatasourceActivities.DataSource()
    source2 = DatasourceCompare.DataSource()
    source3 = DatasourceTop.DataSource()
    ...
    if args.age is not None:
        ...
        print("For people age " + str(args.compare) + " they engaged in " + str(args.activity) \
            + " on average " + str(time) \
            + " hours in 2022 & 2023 and " + str(time2) + " hours in 2012 & 2013")
